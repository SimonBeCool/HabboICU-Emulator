    ...
    public static boolean parse(RoomUser currentUser, String input) {
        ...
        try {
            switch (args[0].toLowerCase()) {
                ...
                case "username":{
                	currentUser.chat(currentUser.getUser().getUsername());
                	return true;
                }
                ...
                case "love": {
                    currentUser.chat("Ich liebe dich Severine Bucher !! Wir sind jetzt 3. Monate zusammen und ich hoffe das es min. 50 Jahre werden <3");
                    return true;
                }
