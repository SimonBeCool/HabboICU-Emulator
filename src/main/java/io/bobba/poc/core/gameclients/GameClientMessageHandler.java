...
public class GameClientMessageHandler {
    ...
    private final static int HIGHEST_MESSAGE_ID = 26;
    ...
    private void registerRequests() {
        ...
        requestHandlers[ClientOpCodes.REQUEST_USER_LOOK] = new RequestUserLook();
        ...
        requestHandlers[ClientOpCodes.REQUEST_ROOM_LEAVE] = new RequestRoomLeave();
    }
}
