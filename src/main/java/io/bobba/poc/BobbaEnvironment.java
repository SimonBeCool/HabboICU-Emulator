...
public class BobbaEnvironment {
    ...
    private static final String VERSION = "New in this version:\n- UPDATE: RoomItem Manager\n- UPDATE: clean code\n- UPDATE VERSION: 1.0.6\n";
    ...
    private BobbaEnvironment() {
        ...
        System.out.println("Copyright (c) 2019 - based by relevance & advanced developed by Satoshi");
        System.out.println();
